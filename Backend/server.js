...
// cloudinary.config({
//   cloud_name: "dnydrlzfu",
//   api_key: 478846291951517,
//   api_secret: "IwLIiIJdTVQyjIaw_JAL8S06bYg",
// });
  ...
  try {
    ...
    if (!candidate) {
      ...
      candidate = new Applications({
        ...
        appliedJobs: [{ jobId: appliedJobId, status: "applied" }],
      });
    } else {
      ...
      if (existingJob) {
        ...
        candidate.appliedJobs.push({ jobId: appliedJobId, status: "applied" });
      }
